...
import { handleAuthFormValidation } from "../../services/authService";
...
function LoginSection({ existsUser }) {
  ...
  const handleSubmit = async (e) => {
    ...
    handleAuthSubmit(formData, existsUser, setResponseMessage, setOpenSnackbar, setFormData, setErrors);
  };
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full px-6 md:w-[50%] mt-2 md:mt-8">
      ...
      >
        ...
        <Button
          type="submit"
          className="bg-blue-500 text-white mt-4 px-8 md:px-12 !py-2.5 !text-base md:!text-lg w-full md:w-auto hover:opacity-85 active:opacity-75"
